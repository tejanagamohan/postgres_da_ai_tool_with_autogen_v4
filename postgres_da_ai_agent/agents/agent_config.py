import os
from postgres_da_ai_agent.modules import db
...
def build_function_map_run_sql(db: PostgresManager):
    return {
        create_func_map("run_sql", db.run_sql)
    }
...
function_map_write_yaml_filre = create_func_map("write_yml_file", file.write_yml_file)
