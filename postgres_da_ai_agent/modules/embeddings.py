...
class DatabaseEmbedder:
    ...
    def add_tables(self, table_name: str, text_representation: str):
    ...
    def get_similar_tables_via_embeddings(self, query, n=3):
        ...
        -n (int, optional): Number of top tables to return. Default to 3.
    ...
    def get_table_definitions_from_names(self, table_names: list) -> list :
        returnc[self.map_name_to_table_def[table_name] for table_name in table_names]
